...
class AddPeople(Toplevel):
    ...
    def add_people(self):
        ...
        if name and surname and mobile and dateofbirth and address !="":
            try:
                #add it to database

                #insert into 'contactbook' (person_name, person_surname, person_mobile, person_dateofbirth, person_email, person_address) values ()
