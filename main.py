...
class Application(object):
    def __init__(self, master):
        ...
        self.top_image_label.place(x=130, y=10)

        self.heading = Label(self.top, text='My Contact Book App',
                             font='arial 15 bold', bg='white', fg='black')
        self.heading.place(x=260, y=50)

        self.date_lbl = Label(self.top, text="Today's date: "+date, font='arial 11 bold', fg='red', bg='white')
